...
# 팔레트 (art_benchmark 기준)
PAL = {
    "wood":   (0.76, 0.55, 0.35), "wood_d": (0.60, 0.42, 0.26),
    "cream":  (0.94, 0.88, 0.78), "linen":  (0.93, 0.89, 0.83),
    "sage":   (0.62, 0.72, 0.52), "sage_d": (0.54, 0.64, 0.44),
    "plant":  (0.28, 0.45, 0.28), "terra":  (0.80, 0.52, 0.40),
    "brass":  (0.68, 0.56, 0.42), "charcoal": (0.28, 0.26, 0.24),
    "skin":   (0.95, 0.82, 0.71), "hair":   (0.22, 0.17, 0.14),
    "knit":   (0.92, 0.82, 0.68), "pants":  (0.40, 0.38, 0.42),
    "shoe":   (0.36, 0.30, 0.26), "eye":    (0.15, 0.13, 0.12),
